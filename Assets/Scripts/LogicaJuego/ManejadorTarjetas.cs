...
namespace CrazyRisk.LogicaJuego
{
    ...
    public class ManejadorTarjetas : MonoBehaviour
    {
        ...
        /// <summary>
        /// Intenta intercambiar 3 tarjetas del jugador y devuelve la cantidad de refuerzos obtenidos
        /// </summary>
        public int IntercambiarYObtenerRefuerzos(Jugador jugador, int indice1, int indice2, int indice3)
        {
            Lista<Tarjeta> tarjetas = jugador.getTarjetas();
            ...
            // Intercambiar y devolver refuerzos
            int refuerzos = manejadorRefuerzos.IntercambiarTarjetas(t1, t2, t3);
